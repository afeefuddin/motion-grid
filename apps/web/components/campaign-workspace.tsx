...
import { AlertTriangle, ArrowLeft, ArrowRight, ArrowUp, Check, CheckCircle2, ChevronRight, FileCheck2, Link2, Megaphone, MessageSquareText, Radio, RefreshCw, Route, ShieldCheck, SlidersHorizontal, Sparkles, X, XCircle } from "lucide-react";
...
import type { Allocation, Approval, CampaignConversationMessage, Edge, Signal, Target } from "../../../src/contracts/entities";
...
function initialProjection(detail: CampaignDetail, plan: PlanData | null): Projection {
  return { plan, targets: detail.targets, allocations: detail.allocations, reasons: {}, droppedCounts: {}, signals: [], edges: [], approvals: detail.approvals, operatingCents: detail.campaign.operatingSpentCents, commitCents: detail.campaign.commitSpentCents, warning: null, replan: null, activities: [] };
}
